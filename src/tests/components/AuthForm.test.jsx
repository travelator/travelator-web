...
describe('AuthForm Component Tests', () => {
    it('should render login form', async () => {
        ...
        expect(await screen.getByRole('heading', { name: /Login/i })).toBeInTheDocument();
        expect(await screen.getByRole('button', { name: /Login/i })).toBeInTheDocument();
    });

    it('should render signup form', async () => {
        render(<AuthForm type="signup" />);
        
        expect(await screen.getByRole('heading', { name: /Sign Up/i })).toBeInTheDocument();
