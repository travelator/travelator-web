const localActivities = [
    ...
    },
    {
        ...
        description:
            'Discover the rich history of the Tower of London, a historic castle on the north bank of the River Thames, known for housing the Crown Jewels.',
        image_link:
    ...
    },
    {
        ...
        description:
            "Experience world-class theatre productions in London's West End, renowned for its vibrant performing arts scene.",
        image_link:
